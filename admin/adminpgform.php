...
if(isset($_POST['submit']))
{
  ...
  {
  $pg_house = $_POST['house'];
  $pg_house = stripcslashes($pg_house);
  

  $pg_house = mysqli_real_escape_string($db, $pg_house);
  }


  if(isset($_POST['locality']))
  {
  $pg_locality = $_POST['locality'];
  $pg_locality = stripcslashes($pg_locality);
  

  $pg_locality = mysqli_real_escape_string($db, $pg_locality);
  }
  ...
  {
  $pg_city = $_POST['city'];
  $pg_city = stripcslashes($pg_city);
  

  $pg_city = mysqli_real_escape_string($db, $pg_city);
  }
  ...
  {
  $pg_pin = $_POST['pin'];
  $pg_pin = stripcslashes($pg_pin);
  

  $pg_pin = mysqli_real_escape_string($db, $pg_pin);
  }
...
//  $type = mysqli_real_escape_string($db, $type);
 ...
 // Validation
  ...
  $sql = "insert into `pg_table` (`ap_id`,`pg_name`,`house`,`locality`,`city`,`pin`,`pg_gender`,`pg_category`,`pg_status`,`pg_meals`,`pg_atb`,`pg_singleroom`,`pg_sharedbed`,`pg_selfcooking`,`pg_ac`,`pg_hotandcold`,`pg_parking`,`pg_price`,`pg_details`) values ('$g_id','$pg_name','$pg_house','$pg_locality','$pg_city','$pg_pin','$pg_gender','$pg_category','$pg_status','$pg_meals','$pg_atb','$pg_singleroom','$pg_sharedbed','$pg_selfcooking','$pg_ac','$pg_hotandcold','$pg_parking','$pg_price','$pg_details')";
        ...
        <div class="row block-9">
          <div class="col-md-12 mb-4  d-flex" style="max-width:800px;">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <input type="text" name="house" id="house" class="form-control" placeholder="House Number and Street Name">
              </div>
              <div class="form-group">
              <input type="text" name="locality" id="locality" class="form-control" placeholder="Locality(Example: Dispur, Ganeshguri,Maligaon etc)">
              </div>
              <div class="form-group">
