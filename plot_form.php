...
//  $type = mysqli_real_escape_string($db, $type);
 ...
 // Validation
  ...
  $sql = "insert into `plot_table` (`property_id`,`location`,`type`,`speci`,`bigha`,`katha`,`lesha`,`daag`,`patta`) values ('$g_id','$loc','$type','$speci','$bigha','$katha','$lesha','$daag','$patta')";
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        ...
        <div class="row block-9">
          ...
          <div class="form-group">
            <input type="text" name="loc" id="loc" class="form-control" placeholder="Enter the location of your plot" required>
            </div>
            <div class="form-group">
            ...
            <input type="text" name="bigha" class="form-control" id="bigha" placeholder="Bigha" required></div>
             <div class="col-md-4 form-group">
            <input type="text" name="katha" class="form-control" id="katha" placeholder="Katha" required></div>
            <div class="col-md-4 form-group">
            <input type="text" name="lesha" class="form-control" id="lesha" placeholder="Lesha" required></div>
            </div>
            <div class="form-group">
