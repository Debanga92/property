    						...
    						<div class="d-md-flex mb-5">
    							<ul>
	    							...
	    							<li>
										...
										if($row['bigha']!=0)
										{ ?>
										<span>Bigha: </span><?php echo $row['bigha']?>,&nbsp;
								<?php	} 
										if($row['katha']!=0)
										{
								?>
										<span>Katha: </span> <?php echo $row['katha']?>,&nbsp;
								<?php    } 
										if($row['lesha']!=0)
										{
								?>
										<span>Lesha: </span> <?php echo $row['lesha']?>
										<?php } ?>
									</li>
	    							
	    							<li><span>Daag Number: </span> <?php echo $row['daag']?></li>
	    							<li><span>Patta Number: </span> <?php echo $row['patta']?></li>
